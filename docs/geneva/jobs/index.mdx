...
### [Backfill Conflicts](/geneva/jobs/conflicts/)
Understand how Geneva handles conflicts during backfill operations, including safe vs conflicting operations, retry behavior, and recovery steps.
