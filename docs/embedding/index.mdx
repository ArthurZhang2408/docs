...
import { RsRsCreateEmptyTableWithEmbeddings } from '/snippets/create_empty_table_embeddings.mdx';
...
## Rust: create_empty_table with embeddings

In the Rust SDK, you can attach embedding definitions when creating an empty table using the builder pattern.

<CodeGroup>
  <CodeBlock filename="Rust" language="Rust" icon="rust">
    {RsRsCreateEmptyTableWithEmbeddings}
  </CodeBlock>
</CodeGroup>
